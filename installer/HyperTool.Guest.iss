...
; Build with:
; ISCC.exe /DMyAppVersion=2.4.2 /DMySourceDir="...\dist\HyperTool.Guest" /DMyOutputDir="...\dist\installer-guest" installer\HyperTool.Guest.iss
...
Source: "{#MySourceDir}\HyperTool.Guest.json"; DestDir: "{app}"; Flags: onlyifdoesntexist ignoreversion uninsneveruninstall skipifsourcedoesntexist
Source: "{#MySourceDir}\HyperTool.Guest.config.json"; DestDir: "{app}"; Flags: onlyifdoesntexist ignoreversion uninsneveruninstall skipifsourcedoesntexist
...
[Icons]
Name: "{group}\HyperTool Guest"; Filename: "{app}\HyperTool.Guest.exe"; IconFilename: "{app}\HyperTool.Guest.exe"; IconIndex: 0; AppUserModelID: "HyperTool.Guest"; Check: ShouldCreateStartMenuGuestShortcut
Name: "{group}\{cm:UninstallShortcut}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\HyperTool Guest"; Filename: "{app}\HyperTool.Guest.exe"; IconFilename: "{app}\HyperTool.Guest.exe"; IconIndex: 0; AppUserModelID: "HyperTool.Guest"; Tasks: desktopicon; Check: ShouldCreateDesktopGuestShortcut
...
function ShouldCreateStartMenuGuestShortcut(): Boolean;
begin
  Result := not ShortcutExists(ExpandConstant('{group}\HyperTool Guest'));
end;

function ShouldCreateDesktopGuestShortcut(): Boolean;
begin
  Result := not ShortcutExists(ExpandConstant('{autodesktop}\HyperTool Guest'));
end;
