...
internal sealed class GuestMainWindow : Window
{
    ...
    private const string UpdateOwner = "KaKTools";
    ...
    private string _releaseUrl = "https://github.com/KaKTools/HyperTool/releases";
    ...
    public void UpdateUsbDevices(IReadOnlyList<UsbIpDeviceInfo> devices)
    {
        ...
        {
            _usbListView.ItemTemplate = null;
        ...
        _usbListView.ItemTemplate = CreateUsbDeviceTemplate();
        _usbListView.ItemsSource = devices;
    ...
    private UIElement BuildUsbPage()
    {
        ...
        listLayout.Children.Add(listBody);
    ...
    private static DataTemplate CreateUsbDeviceTemplate()
    {
...
""";
    ...
    private void OpenReleasePage()
    {
        Process.Start(new ProcessStartInfo
        {
            FileName = string.IsNullOrWhiteSpace(_releaseUrl) ? "https://github.com/KaKTools/HyperTool/releases" : _releaseUrl,
            UseShellExecute = true
        });
    }
